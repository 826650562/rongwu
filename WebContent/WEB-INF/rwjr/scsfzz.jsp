...
<body>
		...
		<div class=" pad15">
			...
			<div class="z-row">
				<div class="z-col">
					...
					<div class="z-row">
						<div class="z-col pszptxt">请拍摄身份证正面照</div>
					</div>
				</div>
				...
				<div class="z-col">
					...
					<div class="z-row">
						<div class="z-col pszptxt">请拍摄身份证反面照</div>
					</div>
				</div>
			</div>
			...
			<div class="z-row padT15">
				<div class="z-col">
					...
					<div class="z-row">
						<div class="z-col pszptxt">请拍摄个人清晰头像</div>
					</div>
				</div>
				<div class="sfzzblank"></div>
				<div class="z-col"></div>
			...
			<div class="z-row padT15 scsfzztishi">
				<div class="z-col">
					...
					<div class="z-row">
						<div class="z-col">（1）请确保拍摄的身份证信息清晰并真实有效</div>
					</div>
					<div class="z-row">
						<div class="z-col">（2）若发现身份证信息非本人，将导致无法办理业务</div>
					</div>
					<div class="z-row">
						<div class="z-col">（3）如有任何疑问，请拨打客服热线：1234234</div>
					</div>
					<div class="z-row">
						<div class="z-col">（4）工作日9：00-18：00</div>
					</div>
				</div>
			</div>
	...
	<script>
		$(function() {
		   $("body").attr("login_user","${auto_login_user}");
		})
	</script>
