...
public class PersonController {
	...
	public void findPerson(HttpServletRequest req,String p_name) {
		//System.out.println(p_name);
		List  xx = this.mapService.getListBySql("select * from person where name = 'bob'");
		System.out.println(xx);
		JSONArray jsonArray = JSONArray.fromObject(xx);
