...
<div class="cztkbox">
 <div class="z-row">
   <div class="z-col cztktxt">您当前的积分为： {{:jifenyue}}</div>
 </div>
 <div class="z-row">
   <div class="z-col cztktxt">您当前的余额为： {{:yue}}元</div>
 </div>
  <div class="z-row">
   <div class="z-col cztktxt">抢单将消耗&nbsp;&nbsp;<span class="colorRed">{{:qdjine}}积分</span>&nbsp;&nbsp;或者&nbsp;&nbsp;<span class="colorRed">{{:qdjine}}元</span></div>
 </div>
 <div class="z-row">
   <div class="z-col cztkzhujie">注：平台贷款由客户自己申请，抢单成功后费用不可退；特殊情况退款，5个工作日内核实处理<a href="#">查看详情</a></div>
 </div>
 ...
 <div class="z-row" style="border-top:1px solid #e6e6e6;">
   <div class="z-col" style="border-right:1px solid #e6e6e6;"><button id="_qdJinfen"  _val="{{:qdjine}}" class="layui-btn tkbtn3">{{:qdjine}}积分抢单</button></div>
   <div class="z-col"><button id="_qdJINe" _val="{{:qdjine}}" class="layui-btn tkbtn3">{{:qdjine}}元抢单</button></div>
 </div>
</script>
...
<body>
							...
							<div class="mui-scroll">
								...
								<div class="qdlist">
									<div class="z-row">
										...
										<div class="z-col">
										 <div class="z-row">
												<div class="z-col tabletitle shuaixuancity" id='cityResult3'>选择城市</div>
												<div class="diquxtb">
		...
		<div id="tabbar-with-chat" class="mui-control-content">
			<div class="mui-content">
				...
				<div class="khsx">
					<div class="z-row">
						<div class="z-col">
							<span class="khsxItemActive khsxItem">待处理</span> <span class="khsxItem">跟进中</span>
				...
				<div class="ddtkgzbox">
					...
					<div class="z-row">
						<div class="z-col">
							<a href="#" class="ddtkgz">系统暂不支持退款，慎重处理</a>
						</div>
					</div>
				</div>

				<div class="qdlist kh_list">
		...
		<div id="tabbar-with-contact" class="mui-control-content">
			...
			<div class="mui-content">
				...
				<div class="wdydycont" style="display:block">
					...
					<div class="z-row marT15" style="height:48px">
						<div class="z-col">
						</div>
					</div>
				</div>
	...
	<script
		src="${basePath }/rwjr/mui-master/examples/hello-mui/js/mui.picker.min.js"></script>
	<!--------layui_moblile js--------->
            ...
            $.ready(function() {
                ...
                cityResult3.addEventListener('tap', function(event) {
                    cityPicker3.show(function(items) {
                        ...
                        if(cityResult3.innerText!="选择城市"){
                            attrs["city"]=cityResult3.innerText;
                        }
