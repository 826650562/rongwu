...
<body>
				...
				<a href="../rwjr/sqrz">
					<div class="topbarleft">
						...
						<script language="javascript">
                            //防止页面后退
                            history.pushState(null, null, "${basePath }/gzyz/index");
						</script>
	...
	<script>
		$(function() {
            ...
            if(!sjh){
                window.location.href="${basePath }/rwjr/login";
            }
			if (!$.trim($("#_city").val())) {
				$.ajax({
					url : "${basePath }/gzyz/scPics",
					type : "post",
					contentType : "application/x-www-form-urlencoded",
					data : {
						url : "http://www.rongwu180.com/rongwu/gzyz/index"
					},
			...
			function dosomething() {
				...
				$("#scgzz").click(function() {
					if (check()) {
						window.location.href = "../gzyz/scsgzzJsp";
					}
				});
				$("#mysubmit").click(function() {
					if (!$("#scgzz").attr("sfzzp_ok")) {
						...
						var _city = $.trim($("#_city").val());
						$.ajax({
							url : "${basePath }/gzyz/saveInfoForuser", //判断申请状态
							type : "post",
							contentType : "application/x-www-form-urlencoded",
							data : {
								_gsmc : _gsmc,
