...
public class SmsDemo {
	...
	static final String accessKeyId = "LTAIOm5vWUD1kh2c";
	static final String accessKeySecret = "aaCUatDhLmcOwYf6SMFqGjWVmseZUf";
	public static void setNumber(String _sjh,String _sjs){
		sjh=_sjh;
		sjs=_sjs;
	}
	...
	public static SendSmsResponse sendSms() throws ClientException {
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("融五服务");
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode("SMS_120125510");
		// 可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
		request.setTemplateParam("{\"code\":\"" + sjs + "\"}");
