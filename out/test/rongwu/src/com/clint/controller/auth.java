...
public class auth {
	...
	public  String loginOut(HttpServletRequest req, HttpServletResponse response) throws IOException {
		req.getSession().setAttribute(Global.USER_SESSION_KEY,"");
		req.getSession().setAttribute(Global.WEIXINOPENID,"");
		return "redirect:/wyqd/index";
	}
}
